    ...
    <div className="bg-slate-50 pb-12 md:pb-20">
      ...
      <div className="container mx-auto px-4 pt-8 md:pt-12">
        <div className="mb-12 text-center">
          <h1 className="mb-4 font-bold text-3xl text-slate-900 md:text-5xl">招生简章</h1>
          <p className="mx-auto max-w-2xl text-lg text-slate-600">为您提供最新、最全面的高考全日制备考方案与招生信息。</p>
        </div>
            ...
            >
              <div className="flex min-w-0 items-start gap-4 md:items-center md:gap-6">
                ...
                <div className="min-w-0 flex-1">
                  <h2 className="wrap-break-word mb-1 font-bold text-slate-900 text-xl md:text-2xl">{brochure.title}</h2>
                  <p className="text-slate-500">发布日期：{Number(brochure.year) - 1}-01-01</p>
                </div>
              </div>
