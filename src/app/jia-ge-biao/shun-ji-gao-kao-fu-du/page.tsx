...
export default function ShunJiGaoKaoFuDuPage() {
  return (
    <div className="min-h-screen bg-white">
      <PageStructuredData />
      <PageTopNav backHref="/jia-ge-biao" backLabel="返回价格表" title="2027 届高考中心总部校区（顺吉）复读优惠政策公示" />
          ...
          <div className="grid items-end gap-12 lg:grid-cols-[minmax(0,1.15fr)_340px]">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg text-slate-300 leading-8">
                为助力 2027 届高考学子高效备考，戴氏教育高考中心总部校区（顺吉）现正式公示本年度优惠政策。涵盖暑期提前批优惠、分数专项减免、团报福利及老生续报专项。政策透明，保障每一位学子的升学之路。
              </p>
        ...
        <div className="grid gap-12 lg:grid-cols-[240px_minmax(0,1fr)]">
          ...
          <div className="space-y-20">
            ...
            <section className="scroll-mt-48 py-2" id="you-hui-zheng-ce">
              <SectionHeading
                description="针对 2027 届高三全科班（含复读生）的暑期提前批报名优惠，以下内容仅按高考中心总部校区（顺吉）口径公示，越早报名优惠力度越大。"
                icon={TagIcon}
                index="01"
                label="暑期报名优惠"
            ...
            <section className="scroll-mt-48 py-2" id="shou-fei-biao-zhun">
              <SectionHeading
                description="本页仅公示高考中心总部校区（顺吉）收费标准，价格透明，无隐形消费。"
                icon={ReceiptIcon}
                index="05"
                label="收费标准详情"
                title="2027 届高考中心总部校区（顺吉）收费公示"
              />
              <InfoTable
