...
export const metadata: Metadata = {
  title: "老师团队",
  description: `查看${SITE_FULL_NAME}核心老师介绍，了解老师履历、教学成果与教研方向。`,
};
      ...
      <main className="pb-16">
        <section className="bg-white">
          <div className="container mx-auto px-4 py-10 md:py-14">
            ...
            <p className="mt-5 max-w-4xl text-lg text-slate-600 leading-8">这里集中展示{SITE_FULL_NAME}核心老师的教学背景、教研方向与代表性成果，方便家长和学生更直观了解师资实力。</p>
            <div className="mt-8">
