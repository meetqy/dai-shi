...
import { getTeacherBySlug, getTeacherDisplayTitle, TEACHERS } from "~/lib/constants/teachers";
...
export default async function TeacherDetailPage({ params }: PageProps) {
  ...
  const profileFacts = [
    ...
    teacher.experience ? { label: "教学经历", value: teacher.experience } : null,
              ...
              <div className="grid gap-8 p-6 md:p-8 lg:grid-cols-[360px_minmax(0,1fr)] lg:gap-12 lg:p-10">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-3">
                    {teacher.campus ? <span className="rounded-full bg-white px-3 py-1.5 text-slate-600 text-sm">{teacher.campus}</span> : null}
                    <p className="font-medium text-primary text-xl">{getTeacherDisplayTitle(teacher)}</p>
                  </div>
