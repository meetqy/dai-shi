...
export const metadata: Metadata = {
	title: "家长服务 - 戴氏教育高考中心",
	description:
		"戴氏教育家长服务中心：学管服务流程、教学管理规范、家长指南、学习方法、备考攻略与高考资讯集中呈现，帮助家长系统性解决高三备考中的各类问题。",
};
				...
				<div className="container mx-auto px-4 py-12 md:py-16">
					<div className="text-center">
						...
						<p className="mx-auto max-w-2xl text-base text-slate-600 leading-relaxed md:text-lg">
							系统性呈现戴氏教育的学管服务流程、教学管理规范、家长沟通指南与备考攻略。
								...
								>
									<div className="flex items-start justify-between gap-4">
										<div className="min-w-0 flex-1">
											{article.highlighted && (
												<div className="mb-3">
													<span className="inline-flex items-center rounded-full bg-amber-50 px-3 py-1 font-medium text-amber-700 text-xs">
														置顶
													</span>
												</div>
											)}
											<h3 className="wrap-break-word mb-2 font-bold text-slate-900 text-xl transition-colors group-hover:text-primary md:text-2xl">
												{article.title}
											</h3>
											<p className="wrap-break-word mb-3 line-clamp-2 text-slate-600 leading-relaxed">
												{article.summary}
											</p>
										</div>
