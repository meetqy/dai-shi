...
const DAI_SHI_VS_DAN_QIU_MEI_YA_TABLE: SimpleArticleTable = {
	...
	rows: [
		{
			dimension: "办学资质类型",
			daishi: "民办高考培训学校（全日制培训资质）",
			danqiuMeiya: "全日制寄宿制高级中学（普通高中办学资质）",
		},
		{
			dimension: "办学许可证合规性",
			daishi: "教育局正规审批，具备民办培训学校办学许可",
			danqiuMeiya: "成都市教育局批准设立，拥有正规高中办学许可，招生代码 13062",
		},
		{
			dimension: "办学年限",
			daishi: "1989 年创立，办学 36 年",
			danqiuMeiya: "依托丹秋教育集团 28 年办学积淀，学校独立办学约 10 年",
		},
		{
			dimension: "全职教师占比",
			daishi: "98%",
			danqiuMeiya: "100% 全职师资配置",
		},
		{
			dimension: "高三/复读带班平均教龄",
			daishi: "平均 8-15 年",
			danqiuMeiya: "平均 10 年以上，领衔教师教龄 15 年+",
		},
		{
			dimension: "师资来源背景",
			daishi: "含四川高考阅卷老师、省级骨干教师、特级教师，985/211 学历教师占比 65%+",
			danqiuMeiya: "由正高级教师、特级教师、省市级学科带头人领衔，搭配资深中青年骨干教师",
		},
		{
			dimension: "班型分层规则",
			daishi: "入学测试学情诊断，按基础分层编班",
			danqiuMeiya: "按高考成绩分层设班，结合学生优劣势匹配班型",
		},
		{
			dimension: "每班学生人数",
			daishi: "大班 30-40 人，精品小班 15-20 人，另有 2-8 人小班",
			danqiuMeiya: "12 人优法班、24 人优思班",
		},
		{
			dimension: "班型种类",
			daishi: "一对一、2-8 人精品小班、15/25 人精品班、30-40 人大班、艺体生定制班",
			danqiuMeiya: "12 人优法小班、24 人优思班，支持单科走班定制",
		},
		{
			dimension: "动态调班机制",
			daishi: "定期测评后根据学情动态调整班型",
			danqiuMeiya: "阶段测评后调整，支持单科走班补弱/培优",
		},
		{
			dimension: "管理模式",
			daishi: "全封闭军事化管理，部分校区支持走读",
			danqiuMeiya: "全封闭寄宿制管理，无走读选项",
		},
		{
			dimension: "班主任配置比例",
			daishi: "双班主任 + 专职学管师配置",
			danqiuMeiya: "校长-班主任-值班老师三级管理，搭配 24 小时生活老师",
		},
		{
			dimension: "作息管理强度",
			daishi: "高强度管控，月休 3-4 天，手机统一收缴",
			danqiuMeiya: "全日制高三作息，全封闭 24 小时值守管控",
		},
		{
			dimension: "家校沟通频次",
			daishi: "常态化学情反馈，定期家校联动",
			danqiuMeiya: "定期反馈学习状态，家校同步学情",
		},
		{
			dimension: "校园/校区场地规模",
			daishi: "主城区多个分校区，全日制集训基地为独立场地",
			danqiuMeiya: "占地 60 亩，园林式独立完整校园",
		},
		{
			dimension: "宿舍住宿配置",
			daishi: "6-8 人间，配独立卫浴、空调，3000-6000 元/期",
			danqiuMeiya: "标准 6 人间，双洗双卫双淋浴，配空调、衣柜、书桌，住宿费 1600 元/学年",
		},
		{
			dimension: "食堂配套标准",
			daishi: "统一配餐，食宿一体化管理",
			danqiuMeiya: "星级智慧食堂，一日四餐供应，AB 菜谱科学轮换，食材可溯源",
		},
		{
			dimension: "教学硬件设施",
			daishi: "标准教室、专属自习室、常规教学设备",
			danqiuMeiya: "标准化理化生实验室、计算机室、多功能报告厅、智慧教室、专业功能室",
		},
		{
			dimension: "运动休闲配套",
			daishi: "基础运动场地与设施",
			danqiuMeiya: "环形塑胶运动场、灯光篮球场、羽毛球场、网球场、乒乓球场、健身房、音乐室、形体室",
		},
		{
			dimension: "自主教材体系",
			daishi: "配套 DSE 教学法自研专属教材",
			danqiuMeiya: "自研《考点全集》等专属教材，配套 5A 教学体系",
		},
		{
			dimension: "测评考试频次",
			daishi: "周测 + 月考常态化，阶段模考同步",
			danqiuMeiya: "定期阶段测评，同步省内大型模考",
		},
		{
			dimension: "模拟试题资源",
			daishi: "成都、绵阳两地模拟卷交叉测评，自研仿真卷",
			danqiuMeiya: "同步省内主流模考卷，配套自研高考仿真试题",
		},
		{
			dimension: "补弱/培优配套课程",
			daishi: "走班补弱课程，一对一单科补强",
			danqiuMeiya: "单科走班定制，靶向查漏补缺，量身定制提分方案",
		},
		{
			dimension: "心理辅导服务",
			daishi: "专职心理老师全程陪伴辅导",
			danqiuMeiya: "配备心理辅导师资，部分教师持有国家二级心理咨询师证",
		},
		{
			dimension: "高考志愿填报指导",
			daishi: "包含升学规划与志愿填报指导服务",
			danqiuMeiya: "提供高考升学规划与志愿填报指导",
		},
		{
			dimension: "学费总价及明细",
			daishi: "大班 3.5-4.5 万/年（部分含食宿），精品小班 5-6 万/年；一对一 200-400 元/课时；住宿费 3000-6000 元/期",
			danqiuMeiya: "复读班 3-6 万/学年（按班型区分）；住宿费 1600 元/学年，书本费 1400 元/学年，代管费 2500 元/学期，生活费 5000 元/学期",
		},
		{
			dimension: "退费政策",
			daishi: "有明确退费规则，按入学协议执行",
			danqiuMeiya: "按官方招生协议约定执行",
		},
		{
			dimension: "收费优惠规则",
			daishi: "高考超二本线/一本线可享学费减免、高分费用返还",
			danqiuMeiya: "设奖学金制度，高考成绩优异者可享学费减免",
		},
		{
			dimension: "隐形消费情况",
			daishi: "收费透明，无强制隐形消费",
			danqiuMeiya: "收费明细公开，无隐形消费",
		},
		{
			dimension: "往届平均提分数据",
			daishi: "平均提分 80-90 分",
			danqiuMeiya: "主打“低进高出”培养，官方未公开统一平均提分值",
		},
		{
			dimension: "本科/重本上线率",
			daishi: "本科上线率约 92%",
			danqiuMeiya: "官方未公开明确上线率数据",
		},
		{
			dimension: "提分案例可溯源性",
			daishi: "有公开往届提分案例，可到校咨询核实",
			danqiuMeiya: "有往届升学案例，可到校咨询了解",
		},
		{
			dimension: "校区地理位置",
			daishi: "成都主城区多校区布局（金牛、青羊、锦江等均有全日制基地）",
			danqiuMeiya: "成都市双流区西航港",
		},
		{
			dimension: "交通便捷程度",
			daishi: "主城区校区周边交通便利，点位多选择灵活",
			danqiuMeiya: "紧邻地铁 30 号线大同路站、地铁 8 号线珠江路站，自驾路网完善",
		},
		{
			dimension: "周边环境",
			daishi: "主城区校区周边生活配套成熟",
			danqiuMeiya: "独立校园，周边环境安静，备考干扰少",
		},
	],
};
