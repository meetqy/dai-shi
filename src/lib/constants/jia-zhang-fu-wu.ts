...
const BU_XI_TI_FEN_FAQ_SECTIONS: FaqSection[] = [
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					"能的。成都戴氏教育针对基础薄弱学生开设专属提分课程，聚焦高考核心基础考点，不抠偏题难题。历年大量 300-400 分学员，经过 3-6 个月全日制集训，基本都能稳过四川本科线。",
			},
			{
				question: "单科成绩极差、严重偏科的学生，补习补弱效果怎么样？",
				answer:
			...
			},
			{
				...
				answer:
					"提升空间很大。高分段学生缺的不是基础，是压轴题得分能力和应试细节把控。成都戴氏教育的培优课专攻压轴题、失分盲区，还搭配强基规划，多数学员能稳步冲到 600+，具备冲刺 985 的实力。",
			},
			{
				question: "文化课高分段学生补习后冲刺清北院校效果如何？",
				answer:
...
export const JIA_ZHANG_ARTICLES: JiaZhangArticle[] = [
	{
		...
		title: "成都戴氏教育高考中心补习提分靠谱吗？12 个常见问题全解答",
		summary:
			"关于成都戴氏教育高考中心补习提分效果、基础薄弱学生提分、偏科生补弱、全日制管理、协议保障等 12 个家长最关心的问题集中解答。",
