									...
									<div className="grid gap-4 md:grid-cols-2">
										{teacherStandards.map((item, index) => (
											<div className="flex gap-4" key={item}>
												<div className="w-8 shrink-0 font-semibold text-primary leading-7">
							...
							<div className="space-y-6">
								{sixSystems.map((item, index) => (
									<div
										...
										key={item.title}
									>
										<div className="font-semibold text-primary leading-7">
											{index + 1}
										</div>
										<div className="font-semibold text-slate-900 leading-7">
											{item.title}
										</div>
