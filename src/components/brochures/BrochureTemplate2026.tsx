          ...
          <div className="grid items-end gap-12 lg:grid-cols-[minmax(0,1.15fr)_320px]">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-lg text-slate-300 leading-8">
                戴氏高考中心，32 年口碑保障，行业领先教育品牌。 围绕教学教研、学情导航、课堂管理、家校沟通与校区环境， 以一份更像正式简章的方式，把核心信息讲清楚。
              </p>
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                <Button asChild className="h-11 px-6 text-base">
                  <Link href={SITE_HOTLINE_TEL}>立即电话咨询</Link>
                </Button>
                <Button
                  asChild
            ...
            <div className="rounded-lg bg-white/6 p-6 backdrop-blur">
              ...
              <ImagePlaceholder align="left" className="mt-8" label="封面主视觉占位" notes="可放品牌主视觉 / 校区航拍 / 视频封面" tag="主视觉" tone="dark" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid gap-12 lg:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <div className="space-y-20">
            ...
            <section className="scroll-mt-24 bg-slate-50/70 px-6 py-10 md:px-8" id="shi-zi">
              ...
              <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
                ...
                <ImagePlaceholder label="师资展示图占位" notes="可放名师合影 / 教研现场 / 讲课实拍" ratioClass="aspect-[4/5]" tag="师资实拍" />
              </div>
            </section>
            ...
            <section className="scroll-mt-24 bg-slate-50/70 px-6 py-10 md:px-8" id="ti-xi">
            ...
            <section className="scroll-mt-24 bg-slate-50/70 px-6 py-10 md:px-8" id="ming-ti">
              <SectionHeading icon={BookOpenCheckIcon} label="命题研究与内部资料" title="32 年命题研究，更懂新高考每 1 分的价值" />
              <div className="grid gap-8 lg:grid-cols-[320px_minmax(0,1fr)]">
                <ImagePlaceholder align="left" label="命题研究图占位" notes="可放内部资料、教研会议、命题研究过程" ratioClass="aspect-[4/5]" tag="教研资料" />
                <div>
            ...
            <section className="scroll-mt-24 bg-slate-50/70 px-6 py-10 md:px-8" id="ke-tang">
            ...
            <section className="scroll-mt-24 py-2" id="jia-xiao">
              ...
              <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
                ...
                <ImagePlaceholder label="家校沟通图占位" notes="可放家长群播报截图 / 直播间海报 / 学习反馈图" ratioClass="aspect-[4/5]" tag="沟通反馈" />
              </div>
            </section>
            ...
            <section className="scroll-mt-24 py-2" id="xiao-qu">
              ...
              <div className="space-y-8">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  <ImagePlaceholder label="教室实景占位" notes="明亮教室 / 上课场景" ratioClass="aspect-[3/2]" tag="校区实景" />
                  <ImagePlaceholder label="食堂实景占位" notes="餐食陈列 / 用餐环境" ratioClass="aspect-[3/2]" tag="校区实景" />
                  <ImagePlaceholder label="住宿实景占位" notes="宿舍环境 / 生活空间" ratioClass="aspect-[3/2]" tag="校区实景" />
                  <ImagePlaceholder label="校区总览占位" notes="校区外立面 / 校园航拍" ratioClass="aspect-[3/2]" tag="校区实景" />
                </div>
                <div className="space-y-6">
            ...
            <section className="scroll-mt-24 bg-slate-50/70 px-6 py-10 md:px-8" id="si-guan">
              <SectionHeading icon={Building2Icon} label="阳光学习 四馆赋能" title="多场馆协同，促进学生全面健康成长" />
              <div className="space-y-8">
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  <ImagePlaceholder label="图书馆占位" notes="资料墙 / 阅览区" ratioClass="aspect-[3/2]" tag="学习空间" />
                  <ImagePlaceholder label="自习馆占位" notes="自习座位 / 督导场景" ratioClass="aspect-[3/2]" tag="学习空间" />
                  <ImagePlaceholder label="体能馆占位" notes="运动训练 / 体能课程" ratioClass="aspect-[3/2]" tag="学习空间" />
                  <ImagePlaceholder label="心能馆占位" notes="心理课程 / 减压活动" ratioClass="aspect-[3/2]" tag="学习空间" />
                </div>
                <div className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <Button asChild className="h-11 px-6">
                    <Link href={SITE_HOTLINE_TEL}>{SITE_HOTLINE_TEXT}</Link>
                  </Button>
