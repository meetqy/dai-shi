...
function AccentCard({
	...
	return (
		<div
			className={`rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)] ${className}`}
		>
			<div className="text-primary text-xs uppercase tracking-[0.22em]">
				{eyebrow}
			</div>
		...
		<div className={`relative overflow-hidden rounded-2xl ${ratioClass}`}>
			{src ? (
				<>
					...
					/>
					<div
						className={`absolute inset-0 ${tone === "dark" ? "bg-slate-950/35" : "bg-slate-950/18"}`}
					/>
				</>
			) : null}
			<div
					...
					<div className="grid items-end gap-12 lg:grid-cols-[minmax(0,1.15fr)_340px]">
						<div>
							...
							<p className="mt-6 max-w-3xl text-lg text-slate-300 leading-8">
								33
								年西南高考教培领航者，用心成就每一份热爱。围绕品牌资质、教学教研、教学管理、校园环境与承诺保障，
								用更完整、更正式的简章方式把核心信息一次讲清楚。
							</p>
						...
						<div className="rounded-2xl bg-white/6 p-6 backdrop-blur">
							<div className="pb-4">
								...
								<div className="mt-2 text-lg leading-8">
									品牌规模与资质、教学教研体系、教学管理体系、环境篇、我们的底气与承诺
								</div>
							</div>
			...
			<div className="container mx-auto px-4 py-12 md:py-16">
				<div className="grid gap-12 lg:grid-cols-[240px_minmax(0,1fr)]">
					...
					<div className="space-y-20">
							...
							<div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
								...
								<div className="rounded-2xl bg-slate-50 p-6">
									...
									<p className="mt-5 text-slate-600 leading-8">
										2027 版简章重点保留 ISO9001
										国际教学质量体系认证与国家版权认证，
										把品牌优势从“口碑表达”进一步升级为“可核验的质量表达”。
									</p>
						...
						<section
							className="scroll-mt-48 bg-slate-50/70 px-6 py-10 md:px-8"
							id="jiao-yan"
						>
							<SectionHeading
										...
										>
											<div className="flex items-start justify-between gap-4">
												<div>
													...
													<h3 className="mt-3 font-bold text-2xl text-slate-900">
														{item.title}
													</h3>
												</div>
						...
						<section className="scroll-mt-48 py-2" id="guan-li">
							...
							<div className="space-y-8">
								{managementItems.map((item, index) => {
									...
									return (
										<div
											className={`${index > 0 ? "border-slate-200 border-t pt-8" : ""} grid gap-6 lg:grid-cols-[220px_minmax(0,1fr)]`}
											key={item.title}
										>
											<div>
						...
						<section className="scroll-mt-48 py-2" id="cheng-nuo">
							...
							<p className="mt-8 max-w-3xl text-slate-600 leading-8">
								三十三载砥砺深耕，戴氏高考中心始终坚守“以学子为中心”的教育初心。我们聚焦教学质量的极致突破，
								以科学严谨的体系赋能，以满怀温度的真心陪伴，用专业与责任护航每一位学子考入理想学府。
							</p>
