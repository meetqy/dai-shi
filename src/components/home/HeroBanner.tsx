      ...
      <div className="absolute inset-0">
        <div className="container mx-auto flex h-full items-center justify-end px-4">
          <div className="max-w-3xl text-white">
            <div className="inline-flex rounded-full border border-white/15 bg-white/10 px-4 py-1.5 font-medium text-sm backdrop-blur-sm">戴氏教育官网 · 高考中心总部</div>
            <h1 className="mt-6 font-bold text-4xl leading-tight md:text-6xl">戴氏教育高考中心总部官网</h1>
