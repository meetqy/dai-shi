...
const SERVICE_ITEMS = [
	"解答高考中心、复读和全日制相关的咨询问题",
	"预约到访总部，现场看教室、宿舍和管理安排",
	"根据孩子成绩情况，沟通现阶段适合的备考方向",
];
						...
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<div className="mt-1 text-slate-700 leading-7">
									欢迎家长预约到访总部，现场看教室、宿舍和管理方式，了解孩子入学后的真实生活与学习节奏。
								</div>
							</div>
						</div>
