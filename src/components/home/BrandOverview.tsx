...
const BUSINESS_ITEMS = [
  {
    title: "品牌介绍",
    description: "了解戴氏教育是谁、做了多少年、获得过哪些荣誉，方便家长先建立基本印象。",
  },
  {
    title: "高考中心",
      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] lg:items-start">
          <div>
            ...
            <h2 className="mt-5 max-w-3xl font-bold text-3xl text-slate-900 leading-tight md:text-4xl">戴氏教育是谁？这里可以一站式了解品牌、总部、高考中心和招生信息。</h2>
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-7 md:p-8">
            <p className="font-semibold text-primary text-sm">戴氏教育主要做哪些事</p>
            ...
            <div className="mt-8 rounded-2xl bg-white px-5 py-4 text-slate-600 text-sm leading-7">戴氏教育总部在成都，家长想了解课程、看环境、问收费，都可以直接打总部电话，老师会一对一为您解答。</div>
          </div>
        </div>
      </div>
    </section>
